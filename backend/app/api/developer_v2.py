...
from ..schemas.schemas import ApiKeyRotateRequest, BindWechatRequest, DeveloperLogin, DeveloperRegister, DeveloperResponse, Token
...
@router.get("/profile", response_model=dict, summary="个人中心基础信息")
...
@router.get("/api-keys", response_model=dict, summary="获取API Key信息")
...
@router.post("/wechat/bind", response_model=dict, summary="绑定微信OpenID")
...
@router.post("/api-keys/rotate", response_model=dict, summary="重置API Key")
